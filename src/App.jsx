  ...
  return (
    <div className="app">
      ...
      <div className="grid-container">
        ...
        >
          <Card title="ios-dashboard-ui" description="UI components from Stripe Dashboard" />
          <Card title="react-stripe-elements" description="React wrapper for Stripe Elements" />
       </Section>

        <Section title="MACHINE LEARNING"
        icon={<img src="https://cdn-icons-png.flaticon.com/512/8969/8969885.png" alt="Machine Learning Icon" className="section-img"/>}>
          <Card title="bonsai" description="Transform tree structures into read-only versions" />
          <Card title="brushfire" description="Distributed decision tree ensemble learning" />
          <Card title="topmodel" description="Standard evaluations for binary classifiers" />
        </Section>
      </div>
    </div>
